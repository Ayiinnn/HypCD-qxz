...
from models.partco_loss_ext import PatchUnConLossAllMin
...
def train(student, train_loader, test_loader, unlabelled_train_loader, args, hyperbolic_projector, hyperbolic_classifier, patch_projector=None, probe=None):
    ...
    if args.part_unsup_neg_agg == 'min':
            ...
            with torch.cuda.amp.autocast(fp16_scaler is not None):
                ...
                if args.part_mode != 'none':
                    ...
                    if args.part_entail_weight > 0 and epoch >= args.warmup_teacher_temp_epochs:
                        _plf = patch_label_1.reshape(patch_label_1.size(0), -1).long()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--part_unsup_neg_agg', type=str, default='full', choices=['full', 'min'],
    ...
    parser.add_argument('--part_unsup_scale', type=float, default=1.0, help='Scale only the unsupervised part term.')
