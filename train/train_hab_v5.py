...
from models.partco_loss_ext import PatchUnConLossAllMin, PatchUnConLossMinDenom
...
if __name__ == "__main__":
    ...
    parser.add_argument('--part_unsup_scale', type=float, default=1.0, help='Scale only the unsupervised part loss.')
