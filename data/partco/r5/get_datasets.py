...
from data.partco.r5.stanford_cars import get_scars_datasets
from data.partco.r5.cub import get_cub_datasets
from data.partco.r5.fgvc_aircraft import get_aircraft_datasets
from data.partco.r5.pets import get_pets_datasets
